...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-center rounded custom-text-bg p-10 text-base-content">
            ...
            <nav>
                <div id="x" className="grid grid-flow-col gap-4">
                    ...
                    <a id="github"  href="https://github.com/0xNordian" target="_blank">
            ...
            <aside>
                <p>
                    Made with ❤️ by Nordian - {currentYear}
                </p>
            </aside>
        </footer>
    )
